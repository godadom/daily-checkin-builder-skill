...
def valid_env(**overrides):
    env = {
        "CHECKIN_BASE_URL": "https://rewards.example.invalid",
        "CHECKIN_STATUS_PATH": "/v1/daily/status",
        "CHECKIN_ACTION_PATH": "/v1/daily/claim",
...
class ConfigTests(unittest.TestCase):
    def test_configuration_read_and_field_validation(self):
        ...
        self.assertEqual(settings.base_url, "https://rewards.example.invalid")
